...
import { addProductInCart, createCart, deleteCart, getCart, updateCart } from "../controllers/cart.controller.js";
...
router.delete("/product/remove/:id",asyncWrapper(addProductInCart))
